...
struct InsiderWidget : URack::UModuleWidget {
    InsiderWidget(Insider *module) {
        ...
        setPanel(APP->window->loadSvg(
            asset::plugin(pluginInstance, "res/Insider.svg")));
        ...
        addParam(createParamCentered<TrimpotGray>(
            mm2px(Vec(17.532, 32.764)), module, Insider::A_ATTEN_PARAM));
        ...
        addParam(createParamCentered<TrimpotGray>(
            mm2px(Vec(17.532, 52.934)), module, Insider::B_ATTEN_PARAM));
        addParam(createParamCentered<Davies1900hSmallWhiteKnob>(
            mm2px(Vec(28.852, 52.935)), module, Insider::B_PARAM));
        addParam(createParamCentered<Davies1900hSmallWhiteKnob>(
            mm2px(Vec(62.76, 52.935)), module, Insider::F_PARAM));
        addParam(createParamCentered<TrimpotGray>(
            mm2px(Vec(17.532, 72.046)), module, Insider::C_ATTEN_PARAM));
        addParam(createParamCentered<Davies1900hSmallWhiteKnob>(
            mm2px(Vec(28.852, 72.046)), module, Insider::C_PARAM));
        addParam(createParamCentered<Davies1900hSmallWhiteKnob>(
            mm2px(Vec(62.76, 72.046)), module, Insider::G_PARAM));
        addParam(createParamCentered<TrimpotGray>(
            mm2px(Vec(17.532, 91.158)), module, Insider::D_ATTEN_PARAM));
        addParam(createParamCentered<Davies1900hSmallWhiteKnob>(
            mm2px(Vec(28.852, 91.158)), module, Insider::D_PARAM));
        addParam(createParamCentered<Davies1900hSmallWhiteKnob>(
            mm2px(Vec(62.76, 91.158)), module, Insider::H_PARAM));
        addParam(createParamCentered<LEDBezel>(mm2px(Vec(44.771, 108.759)),
                                               module, Insider::ACTIVE_PARAM));
        addChild(createLightCentered<LEDBezelLight<RedLight>>(
            mm2px(Vec(44.771, 108.759)), module, Insider::ACTIVE_LIGHT));

        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(8.291, 32.764)),
                                                 module, Insider::A_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(49.607, 32.764)),
                                                 module, Insider::E_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(8.291, 52.935)),
                                                 module, Insider::B_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(49.607, 52.935)),
                                                 module, Insider::F_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(8.291, 72.046)),
                                                 module, Insider::C_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(49.607, 72.046)),
                                                 module, Insider::G_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(8.291, 91.158)),
                                                 module, Insider::D_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(49.607, 91.158)),
                                                 module, Insider::H_INPUT));
        ...
        addInput(createInputCentered<PJ301MPort>(
            mm2px(Vec(56.323, 108.759)), module, Insider::ACTIVE_INPUT));
    ...
    void appendContextMenu(Menu *menu) override {
        ...
        //   hostItem->rightText = CHECKMARK(socketInfo->hostNum ==
        //   module->hostNum); menu->addChild(hostItem);
        // }
