...
struct Mirage2x : URack::UModule {
  ...
  Mirage2x() {
    ...
    configUpdate("TurbulenceAmount", TURBULENCE_AMOUNT_PARAM,
                 TURBULENCE_AMOUNT_INPUT, TURBULENCE_AMOUNT_ATTEN_PARAM, 0.f);
    ...
    configUpdate("ParticleShape", PARTICLE_SHAPE_PARAM, PARTICLE_SHAPE_INPUT,
                 PARTICLE_SHAPE_ATTEN_PARAM, 0.f);
    configUpdate("TurbulenceYScale", TURBULENCE_Y_SCALE_PARAM,
                 TURBULENCE_Y_SCALE_INPUT, TURBULENCE_Y_SCALE_ATTEN_PARAM, 5.f);
    ...
    configUpdate("TurbulenceFrequency", TURBULENCE_FREQUENCY_PARAM,
                 TURBULENCE_FREQUENCY_INPUT, TURBULENCE_FREQUENCY_ATTEN_PARAM,
                 5.f);
    ...
    configBiUpdate("PositionY", POSITION_Y_PARAM, POSITION_Y_INPUT, -1, 0.25f);
    configBiUpdate("PositionZ", POSITION_Z_PARAM, POSITION_Z_INPUT, -1, 3.f);
    ...
    configUpdate("TextureSelectB", TEXTURE_SELECT_B_PARAM,
                 TEXTURE_SELECT_B_INPUT, TEXTURE_SELECT_B_ATTEN_PARAM, 10.f);
    ...
    configUpdate("Blend", BLEND_PARAM, BLEND_INPUT, BLEND_ATTEN_PARAM, 0.f);
  }
...
struct Mirage2xWidget : URack::UModuleWidget {
  Mirage2xWidget(Mirage2x *module) {
    ...
    addParam(createParamCentered<LEDBezel>(mm2px(Vec(160.375, 10.44)), module,
                                           Mirage2x::ACTIVE_PARAM));
    ...
    addParam(
        createParamCentered<TrimpotGray>(mm2px(Vec(81.421, 37.758)), module,
                                         Mirage2x::WARP_DISTANCE_ATTEN_PARAM));
    addParam(createParamCentered<Davies1900hSmallWhiteKnob>(
        mm2px(Vec(43.629, 41.51)), module, Mirage2x::TURBULENCE_X_SCALE_PARAM));
    addParam(createParamCentered<Davies1900hSmallWhiteKnob>(
    ...
    addParam(createParamCentered<Davies1900hCustomWhiteKnob>(
        mm2px(Vec(155.635, 43.093)), module, Mirage2x::SIMULATION_SPEED_PARAM));
    addParam(createParamCentered<Davies1900hCustomWhiteKnob>(
        mm2px(Vec(13.406, 44.148)), module, Mirage2x::TURBULENCE_AMOUNT_PARAM));
    addParam(createParamCentered<Davies1900hCustomWhiteKnob>(
    ...
    addParam(
        createParamCentered<TrimpotGray>(mm2px(Vec(94.736, 50.956)), module,
                                         Mirage2x::WARP_X_EULER_ATTEN_PARAM));
    addParam(
        createParamCentered<TrimpotGray>(mm2px(Vec(136.802, 58.158)), module,
                                         Mirage2x::PARTICLE_SIZE_ATTEN_PARAM));
    addParam(
        createParamCentered<TrimpotGray>(mm2px(Vec(167.35, 58.158)), module,
                                         Mirage2x::PARTICLE_SHAPE_ATTEN_PARAM));
    addParam(createParamCentered<TrimpotGray>(
        mm2px(Vec(25.122, 61.859)), module,
        Mirage2x::TURBULENCE_FREQUENCY_ATTEN_PARAM));
    addParam(createParamCentered<TrimpotGray>(
        mm2px(Vec(81.421, 61.859)), module, Mirage2x::WARP_SHARD_ATTEN_PARAM));
    addParam(createParamCentered<Davies1900hCustomWhiteKnob>(
        mm2px(Vec(125.086, 64.548)), module, Mirage2x::PARTICLE_SIZE_PARAM));
    addParam(createParamCentered<Davies1900hCustomWhiteKnob>(
        mm2px(Vec(155.635, 64.548)), module, Mirage2x::PARTICLE_SHAPE_PARAM));
    addParam(createParamCentered<Davies1900hSmallWhiteKnob>(
    ...
    addParam(
        createParamCentered<TrimpotGray>(mm2px(Vec(94.736, 75.056)), module,
    ...
    addParam(createParamCentered<Davies1900hCustomWhiteKnob>(
        mm2px(Vec(27.325, 101.506)), module, Mirage2x::TEXTURE_SELECT_A_PARAM));
    addParam(createParamCentered<Davies1900hCustomWhiteKnob>(
        mm2px(Vec(86.18, 101.506)), module, Mirage2x::TEXTURE_SELECT_B_PARAM));
    addParam(createParamCentered<Davies1900hSmallWhiteKnob>(
    ...
    addParam(createParamCentered<Davies1900hSmallWhiteKnob>(
        mm2px(Vec(35.848, 117.231)), module, Mirage2x::TEXTURE_SCALE_PARAM));
    addParam(
        createParamCentered<TrimpotGray>(mm2px(Vec(25.135, 117.537)), module,
                                         Mirage2x::TEXTURE_SCALE_ATTEN_PARAM));

    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(171.438, 10.44)), module,
                                             Mirage2x::ACTIVE_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(140.866, 45.23)), module,
                                             Mirage2x::GLOW_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(171.414, 45.23)), module,
                                             Mirage2x::SIMULATION_SPEED_INPUT));
    addInput(createInputCentered<PJ301MPort>(
        mm2px(Vec(29.186, 46.285)), module, Mirage2x::TURBULENCE_AMOUNT_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(85.485, 46.285)), module,
                                             Mirage2x::WARP_DISTANCE_INPUT));
    addInput(
    ...
    addInput(createInputCentered<PJ301MPort>(
        mm2px(Vec(171.414, 66.684)), module, Mirage2x::PARTICLE_SHAPE_INPUT));
    addInput(
        createInputCentered<PJ301MPort>(mm2px(Vec(29.186, 70.385)), module,
                                        Mirage2x::TURBULENCE_FREQUENCY_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(85.485, 70.385)), module,
                                             Mirage2x::WARP_SHARD_INPUT));
    addInput(
        createInputCentered<PJ301MPort>(mm2px(Vec(47.793, 75.056)), module,
                                        Mirage2x::TURBULENCE_Y_SCALE_INPUT));
    addInput(createInputCentered<PJ301MPort>(
        mm2px(Vec(104.092, 75.056)), module, Mirage2x::WARP_Y_EULER_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(132.23, 83.671)), module,
                                             Mirage2x::POSITION_X_INPUT));
    addInput(createInputCentered<PJ301MPort>(
    ...
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(171.27, 99.851)), module,
                                             Mirage2x::ROTATION_Z_INPUT));
    addInput(createInputCentered<PJ301MPort>(
        mm2px(Vec(11.546, 103.643)), module, Mirage2x::TEXTURE_SELECT_A_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(101.959, 103.643)),
                                             module,
                                             Mirage2x::TEXTURE_SELECT_B_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(132.086, 116.173)),
                                             module, Mirage2x::GAIN_RED_INPUT));
    addInput(createInputCentered<PJ301MPort>(
        mm2px(Vec(151.678, 116.173)), module, Mirage2x::GAIN_GREEN_INPUT));
    addInput(createInputCentered<PJ301MPort>(
        mm2px(Vec(171.27, 116.173)), module, Mirage2x::GAIN_BLUE_INPUT));
    addInput(createInputCentered<PJ301MPort>(
        mm2px(Vec(15.779, 117.537)), module, Mirage2x::TEXTURE_SCALE_INPUT));

    addParam(createParamCentered<WhiteHorizontalSlider>(
        mm2px(Vec(57.105, 104.038)), module, Mirage2x::BLEND_PARAM));
    addParam(createParamCentered<TrimpotGray>(mm2px(Vec(58, 117.537)), module,
                                              Mirage2x::BLEND_ATTEN_PARAM));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(65, 118)), module,
                                             Mirage2x::BLEND_INPUT));
  }
};
