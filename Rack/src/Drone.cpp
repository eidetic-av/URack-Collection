...
struct Drone : URack::UModule {
    ...
    enum LightIds { ACTIVE_LIGHT, TARGET_LIGHT, NUM_LIGHTS };
    ...
    Drone() {
        ...
        configBiUpdate("Orbit", ORBIT_PARAM, ORBIT_INPUT, ORBIT_ATTEN_PARAM,
                       0.f);
        configBiUpdate("Elevation", ELEVATION_PARAM, ELEVATION_INPUT,
                       ELEVATION_ATTEN_PARAM, 0.f);
        configUpdate("Distance", DISTANCE_PARAM, DISTANCE_INPUT,
                     DISTANCE_ATTEN_PARAM, 0.f);
    ...
    void onLoad(json_t *rootJ) override {
        ...
        if (targetJ)
            target = json_integer_value(targetJ);
    }
...
struct DroneWidget : URack::UModuleWidget {
    DroneWidget(Drone *module) {
        ...
        setPanel(APP->window->loadSvg(
            asset::plugin(pluginInstance, "res/Drone.svg")));
        ...
        addParam(createParamCentered<TrimpotGray>(
            mm2px(Vec(29.701, 95.994)), module, Drone::ELEVATION_ATTEN_PARAM));
        addParam(createParamCentered<TrimpotGray>(
            mm2px(Vec(52.339, 95.994)), module, Drone::DISTANCE_ATTEN_PARAM));
        addParam(createParamCentered<LEDBezel>(mm2px(Vec(16.625, 108.759)),
                                               module, Drone::ACTIVE_PARAM));
        addChild(createLightCentered<LEDBezelLight<RedLight>>(
            mm2px(Vec(16.625, 108.759)), module, Drone::ACTIVE_LIGHT));
        addParam(createParamCentered<LEDBezel>(mm2px(Vec(42.437, 108.759)),
                                               module, Drone::TARGET_PARAM));
        addChild(createLightCentered<LEDBezelLight<BlueLight>>(
            mm2px(Vec(42.437, 108.759)), module, Drone::TARGET_LIGHT));

        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(17.753, 56.251)),
                                                 module, Drone::X_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(40.39, 56.251)),
                                                 module, Drone::Y_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(63.028, 56.251)),
                                                 module, Drone::Z_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(17.753, 95.994)),
                                                 module, Drone::ORBIT_INPUT));
        addInput(createInputCentered<PJ301MPort>(
            mm2px(Vec(40.39, 95.994)), module, Drone::ELEVATION_INPUT));
        addInput(createInputCentered<PJ301MPort>(
            mm2px(Vec(63.028, 95.994)), module, Drone::DISTANCE_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(28.177, 108.759)),
                                                 module, Drone::ACTIVE_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(53.989, 108.759)),
                                                 module, Drone::TARGET_INPUT));
    }
};
