...
struct PlyPlayer : URack::UModule {
  ...
  enum OutputIds { POINT_CLOUD_OUTPUT, NUM_OUTPUTS };
  ...
  static void loadSequenceNames(void *instance,
    ...
    for (unsigned int i = 0; i < sequences.size(); i++) {
      ...
      if (thisModule->selectedSequence != -1)
        continue;
  ...
  void start() override {
    ...
    URack::networkManager->dispatcher->query(
        activeHosts, instanceAddress + "/QueryUserAssets", loadSequenceNames,
        this);
  }
  ...
  void loadSequence(std::string sequenceName) {
    auto it =
        std::find(sequenceNames.begin(), sequenceNames.end(), sequenceName);
    ...
    URack::networkManager->dispatcher->action(
        activeHosts, instanceAddress + "/LoadSequence", selectedSequenceName);
  }

  void nextSequence() {
    unsigned int newIndex = selectedSequence + 1;
    if (newIndex > sequenceNames.size() - 1)
      newIndex = 0;
  ...
  json_t *onSave() override {
    ...
    json_object_set_new(rootJ, "selectedSequenceName",
                        json_string(selectedSequenceName.c_str()));
    return rootJ;
  }
...
struct PlyPlayerWidget : URack::UModuleWidget {
  ...
  PlyPlayerWidget(PlyPlayer *module) {
    ...
    setPanel(APP->window->loadSvg(
        asset::plugin(pluginInstance, "res/PlyPlayer.svg")));
    ...
    addParam(createParamCentered<Davies1900hSmallWhiteKnob>(
        mm2px(Vec(29.445, 25.496)), module, PlyPlayer::POSITION_X_PARAM));
    addParam(createParamCentered<Davies1900hSmallWhiteKnob>(
        mm2px(Vec(43.373, 25.496)), module, PlyPlayer::POSITION_Y_PARAM));
    addParam(createParamCentered<Davies1900hSmallWhiteKnob>(
        mm2px(Vec(57.281, 25.496)), module, PlyPlayer::POSITION_Z_PARAM));
    addParam(createParamCentered<Davies1900hSmallWhiteKnob>(
        mm2px(Vec(8.438, 47.143)), module, PlyPlayer::ROTATION_X_PARAM));
    addParam(createParamCentered<Davies1900hSmallWhiteKnob>(
        mm2px(Vec(22.346, 47.143)), module, PlyPlayer::ROTATION_Y_PARAM));
    addParam(createParamCentered<Davies1900hSmallWhiteKnob>(
        mm2px(Vec(36.274, 47.143)), module, PlyPlayer::ROTATION_Z_PARAM));
    addParam(createParamCentered<TrimpotGray>(
        mm2px(Vec(51.341, 70.112)), module, PlyPlayer::SCALE_ATTEN_PARAM));
    addParam(createParamCentered<Davies1900hCustomWhiteKnob>(
        mm2px(Vec(42.801, 79.148)), module, PlyPlayer::SCALE_PARAM));
    addParam(createParamCentered<LEDBezel>(mm2px(Vec(16.566, 84.062)), module,
                                           PlyPlayer::ACTIVE_PARAM));
    addChild(createLightCentered<LEDBezelLight<RedLight>>(
        mm2px(Vec(16.566, 84.062)), module, PlyPlayer::ACTIVE_LIGHT));
    addParam(createParamCentered<TrimpotGray>(mm2px(Vec(51.015, 96.4)), module,
                                              PlyPlayer::SPEED_ATTEN_PARAM));
    addParam(createParamCentered<Davies1900hCustomWhiteKnob>(
        mm2px(Vec(19.422, 100.522)), module, PlyPlayer::RUN_PARAM));
    addParam(createParamCentered<Davies1900hCustomWhiteKnob>(
        mm2px(Vec(42.475, 105.435)), module, PlyPlayer::SPEED_PARAM));
    addParam(createParamCentered<Davies1900hCustomWhiteKnob>(
        mm2px(Vec(22.754, 116.333)), module, PlyPlayer::RESET_PARAM));

    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(29.445, 36.124)), module,
                                             PlyPlayer::POSITION_X_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(43.373, 36.124)), module,
                                             PlyPlayer::POSITION_Y_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(57.281, 36.124)), module,
                                             PlyPlayer::POSITION_Z_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(8.438, 57.771)), module,
                                             PlyPlayer::ROTATION_X_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(22.346, 57.771)), module,
                                             PlyPlayer::ROTATION_Y_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(36.274, 57.771)), module,
                                             PlyPlayer::ROTATION_Z_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(56.464, 79.168)), module,
                                             PlyPlayer::SCALE_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(5.527, 84.063)), module,
                                             PlyPlayer::ACTIVE_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(8.383, 100.522)), module,
                                             PlyPlayer::RUN_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(56.137, 105.455)),
                                             module, PlyPlayer::SPEED_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(11.715, 116.567)),
                                             module, PlyPlayer::RESET_INPUT));

    addPointCloudOutput(mm2px(Vec(56.035, 120.973)), module,
                        PlyPlayer::POINT_CLOUD_OUTPUT, "PointCloudOutput");
    ...
    addParam(createParam<LEDButton>(mm2px(Vec(2, 10)), module,
                                    PlyPlayer::PREV_SEQ_PARAM));
    addParam(createParam<LEDButton>(mm2px(Vec(23, 10)), module,
                                    PlyPlayer::NEXT_SEQ_PARAM));
